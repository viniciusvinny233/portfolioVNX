  ...
  return (
    <>
      ...
      <div className="w-full flex">
        Os projetos a seguir destacam minhas habilidades e experiências por meio
        de exemplos práticos do meu trabalho. Cada projeto é brevemente
        descrito, com links para as demonstrações ao vivo.
      </div>
